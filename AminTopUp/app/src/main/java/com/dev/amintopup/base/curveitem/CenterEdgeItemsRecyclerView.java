...
public class CenterEdgeItemsRecyclerView extends RecyclerView {
    ...
    public boolean onGenericMotionEvent(MotionEvent ev) {
        ...
        return layoutManager != null && !this.isLayoutSuppressed() && super.onGenericMotionEvent(ev);//isLayoutFrozen
    }
    ...
    private void setupCenteredPadding() {
        if (this.mCenterEdgeItems && this.getChildCount() >= 1) {
            ...
            if (this.getPaddingTop() != desiredPadding) {
                ...
                int focusedPosition = focusedChild != null ? Objects.requireNonNull(this.getLayoutManager()).getPosition(focusedChild) : 0;
                Objects.requireNonNull(this.getLayoutManager()).scrollToPosition(focusedPosition);
            }
