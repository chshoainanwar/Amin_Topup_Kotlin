...
class CountryCodeDialog {
    ...
    openCountryCodeDialog(final CountryCodePicker codePicker, final String countryNameCode) {
        ...
        Double width = Math.floor(Double.parseDouble(Resources.getSystem().getDisplayMetrics().widthPixels + "") * 0.9);//ViewGroup.LayoutParams.MATCH_PARENT;
        Double height = Math.floor(Double.parseDouble(Resources.getSystem().getDisplayMetrics().heightPixels + "") * 0.9);//ViewGroup.LayoutParams.MATCH_PARENT;
