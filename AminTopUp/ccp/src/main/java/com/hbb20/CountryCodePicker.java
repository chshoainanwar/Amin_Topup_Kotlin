...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        codePicker = this;
        setTextColor(R.color.defaultContentColor);
        if (attrs != null) {
    ...
    void setTextColor(int color){
        textView_selectedCountry.setTextColor(color);
    }
...
//        Log.d(TAG, "getCCPLanguageFromLocale: current locale language" + currentLocale.getLanguage());
    ...
    public void setImageViewFlag(CircleImageView imageViewFlag) {
